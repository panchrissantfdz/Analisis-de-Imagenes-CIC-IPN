...
#pragma resource "*.dfm"
TFormGeodesicDilation *FormGeodesicDilation;
//---------------------------------------------------------------------------
__fastcall TFormGeodesicDilation::TFormGeodesicDilation(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFormGeodesicDilation::BitBtnMarkerClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormGeodesicDilation::BitBtnMaskClick(TObject *Sender)
{
TMDIChild *Child=(TMDIChild *)MainForm->ActiveMDIChild;
if(Child!=NULL){
int anchoOriginal=Child->Image->Picture->Bitmap->Width;
...
//---------------------------------------------------------------------------
void __fastcall TFormGeodesicDilation::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormGeodesicDilation::BitBtnOKClick(TObject *Sender)
{
...
Mascara=FSEB->Morpho->dilateG(Mascara,FSEB->EE,FSEB->ox,FSEB->oy);
Marcadora=FSEB->Morpho->dilGeo(Marcadora,Mascara);
