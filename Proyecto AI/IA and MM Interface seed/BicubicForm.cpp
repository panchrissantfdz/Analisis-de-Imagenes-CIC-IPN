...
#pragma resource "*.dfm"
TFormBicubic *FormBicubic;
//---------------------------------------------------------------------------
__fastcall TFormBicubic::TFormBicubic(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFormBicubic::BitBtn1Click(TObject *Sender)
{
...
try
{
MainForm->Pdi->InterpolacionBicubic(BitmapZoom,Child->Image->Picture->Bitmap,dimension,dimension);
...
String name=ExtractFilePath(Child->FileName)+"\Interpolacion Bicubic "+dimension+"="+ExtractFileName(Child->FileName);
MainForm->CreateMDIChild(name,BitmapZoom);
TMDIChild *Child2 =(TMDIChild *)MainForm->ActiveMDIChild;
String proceso=": Interpolacion Bicubic";
