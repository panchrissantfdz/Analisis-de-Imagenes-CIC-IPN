...
//---------------------------------------------------------------------------
void __fastcall TFormZoom::BitBtnOKClick(TObject *Sender)
{
...
try
{
MainForm->Pdi->ZoomImagen(BitmapZoom,Child->Image->Picture->Bitmap,dimension,dimension);
...
String name=ExtractFilePath(Child->FileName)+"\Zoom "+dimension+"="+ExtractFileName(Child->FileName);
